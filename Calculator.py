...
cal=Tk()
cal.minsize(width=340,height=500)
cal.maxsize(width=320,height=500)
cal.title("calculator")
operator=" "
text_Input=StringVar()

txtDisplay=Entry(cal,font=('arial',18,BOLD),textvariable=text_Input,bd=30,insertwidth=4,bg="blue",justify="right").grid(columnspan=4)
...
Multply=Button(cal,padx=16,pady=16,bd=8,fg="black",font=('arial',20,BOLD),
